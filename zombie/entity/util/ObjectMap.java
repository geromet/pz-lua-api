...
implements Iterable<Entry<K, V>> {
    ...
    protected int shift;
    protected int mask;
    transient Entries<K, V> entries1;
    transient Entries<K, V> entries2;
    transient Values<V> values1;
    transient Values<V> values2;
    transient Keys<K> keys1;
    transient Keys<K> keys2;
