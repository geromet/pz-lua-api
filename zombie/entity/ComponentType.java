...
import zombie.entity.ComponentFactory;
import zombie.entity.ComponentScriptFactory;
...
public enum ComponentType {
    Attributes(1, AttributeContainer.class, AttributesScript.class, 0),
    FluidContainer(2, FluidContainer.class, FluidContainerScript.class, 2, EnumBitStore.of(GameEntityType.IsoObject, GameEntityType.MetaEntity)),
    SpriteConfig(3, SpriteConfig.class, SpriteConfigScript.class, 0, EnumBitStore.of(GameEntityType.IsoObject, GameEntityType.MetaEntity)),
    Lua(6, LuaComponent.class, LuaComponentScript.class, 0),
    Parts(7, Parts.class, PartsScript.class, 0),
    Signals(8, Signals.class, SignalsScript.class, 0),
    Script(9, EntityScriptInfo.class, null, 0),
    UiConfig(11, UiConfig.class, UiConfigScript.class, 0),
    CraftLogic(12, CraftLogic.class, CraftLogicScript.class, 3, EnumBitStore.of(GameEntityType.IsoObject, GameEntityType.MetaEntity)),
    FurnaceLogic(13, FurnaceLogic.class, FurnaceLogicScript.class, 3, EnumBitStore.of(GameEntityType.IsoObject, GameEntityType.MetaEntity)),
    TestComponent(14, TestComponent.class, TestComponentScript.class, 0),
    MashingLogic(15, MashingLogic.class, MashingLogicScript.class, 3, EnumBitStore.of(GameEntityType.IsoObject, GameEntityType.MetaEntity)),
    DryingLogic(16, DryingLogic.class, DryingLogicScript.class, 3, EnumBitStore.of(GameEntityType.IsoObject, GameEntityType.MetaEntity)),
    MetaTag(17, MetaTagComponent.class, null, 0, EnumBitStore.of(GameEntityType.IsoObject, GameEntityType.MetaEntity)),
    Resources(18, Resources.class, ResourcesScript.class, 3, EnumBitStore.of(GameEntityType.IsoObject, GameEntityType.MetaEntity)),
    CraftBench(19, CraftBench.class, CraftBenchScript.class, 0),
    CraftRecipe(20, CraftRecipeComponent.class, CraftRecipeComponentScript.class, 0),
    Durability(21, Durability.class, DurabilityScript.class, 0),
    DryingCraftLogic(22, DryingCraftLogic.class, DryingCraftLogicScript.class, 3, EnumBitStore.of(GameEntityType.IsoObject, GameEntityType.MetaEntity)),
    ContextMenuConfig(23, ContextMenuConfig.class, ContextMenuConfigScript.class, 0),
    SpriteOverlayConfig(24, SpriteOverlayConfig.class, SpriteOverlayConfigScript.class, 0, EnumBitStore.of(GameEntityType.IsoObject, GameEntityType.MetaEntity)),
    CraftBenchSounds(25, CraftBenchSounds.class, CraftBenchSoundsScript.class, 0),
    WallCoveringConfig(26, WallCoveringConfig.class, WallCoveringConfigScript.class, 0),
    Undefined(0, null, null, 0);

    private static final Map<Short, ComponentType> idMap;
    private static final Map<Class<?>, ComponentType> classMap;
    private static final ArrayList<ComponentType> list;
    private static final ComponentType[] array;
    static final BitSet bitsAddToEngine;
    static final BitSet bitsRunInMeta;
    static final BitSet bitsRenderLast;
    private static final ComponentFactory componentFactory;
    private static final ComponentScriptFactory scriptFactory;
    ...
    private <T extends Component, E extends ComponentScript> ComponentType(short i, Class<T> componentClass, Class<E> scriptClass, int flags) {
        this(i, componentClass, scriptClass, flags, EnumBitStore.allOf(GameEntityType.class));
    }

    private <T extends Component, E extends ComponentScript> ComponentType(short i, Class<T> componentClass, Class<E> scriptClass, int flags, EnumBitStore<GameEntityType> validEntityTypes) {
        this.id = i;
        this.flags = flags;
    ...
    public ComponentScript CreateComponentScript() {
        ...
        if (script == null) {
            throw new RuntimeException("Unable to create script for component (No script class defined?): " + String.valueOf((Object)this));
        }
        return script;
    }
    ...
    static {
        idMap = new HashMap<Short, ComponentType>();
        classMap = new HashMap();
        list = new ArrayList();
        bitsAddToEngine = new BitSet();
        bitsRunInMeta = new BitSet();
        bitsRenderLast = new BitSet();
        componentFactory = new ComponentFactory();
        scriptFactory = new ComponentScriptFactory();
        int maxIndex = 0;
        ...
        Arrays.fill((Object[])array, (Object)Undefined);
        ComponentType[] componentTypeArray = ComponentType.values();
        int n = componentTypeArray.length;
        for (int i = 0; i < n; ++i) {
            ComponentType type;
            ComponentType.array[type.GetID()] = type = componentTypeArray[i];
        }
    }
}
