...
extends SealedFluidProperties {
    public SealedFluidProperties getSealedFluidProperties() {
        ...
        sealed.setEffects(this.getFatigueChange(), this.getHungerChange(), this.getStressChange(), this.getThirstChange(), this.getUnhappyChange(), this.getAlcohol(), this.getPoison());
