...
public class SealedFluidProperties {
    ...
    public boolean hasProperties() {
        ...
        return this.foodSicknessChange != 0;
    }
    ...
    protected void addFromMultiplied(SealedFluidProperties other, float multi) {
        this.fatigueChange += other.fatigueChange * multi;
        this.hungerChange += other.hungerChange * multi;
        this.stressChange += other.stressChange * multi;
        this.thirstChange += other.thirstChange * multi;
        this.unhappyChange += other.unhappyChange * multi;
        this.calories += other.calories * multi;
        this.carbohydrates += other.carbohydrates * multi;
        this.lipids += other.lipids * multi;
        this.proteins += other.proteins * multi;
        this.alcohol += other.alcohol * multi;
        this.poison += other.poison * multi;
        this.fluReduction += other.fluReduction * multi;
        this.painReduction += other.painReduction * multi;
        this.enduranceChange += other.enduranceChange * multi;
    }

    protected void setEffects(float fatigueChange, float hungerChange, float stressChange, float thirstChange, float unhappyChange, float alcoholChange, float poisonChange) {
