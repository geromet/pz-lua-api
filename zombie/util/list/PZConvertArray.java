...
implements RandomAccess {
    ...
    public int indexOf(Object val) {
        ...
        for (int i = 0; i < count; ++i) {
            if (!PZConvertArray.objectsEqual(val, this.get(i))) continue;
            indexOf = i;
            break;
        }
        return indexOf;
    ...
    public void sort(Comparator<? super T> c) {
        Arrays.sort(this.array, (o1, o2) -> c.compare((T)this.convertST(o1), (T)this.convertST(o2)));
    }
