...
public final class Stacks {
    ...
    public static final class Params7 {
        ...
        public static final class CallbackStackItem<T1, T2, T3, T4, T5, T6, T7>
        extends StackItem<T1, T2, T3, T4, T5, T6, T7> {
            private ICallback<T1, T2, T3, T4, T5, T6, T7> callback;
            private static final Pool<CallbackStackItem<Object, Object, Object, Object, Object, Object, Object>> s_pool = new Pool<CallbackStackItem>(CallbackStackItem::new);
            ...
            public static <T1, T2, T3, T4, T5, T6, T7> CallbackStackItem<T1, T2, T3, T4, T5, T6, T7> alloc(T1 val1, T2 val2, T3 val3, T4 val4, T5 val5, T6 val6, T7 val7, ICallback<T1, T2, T3, T4, T5, T6, T7> callback) {
                CallbackStackItem<Object, Object, Object, Object, Object, Object, Object> item = s_pool.alloc();
                item.val1 = val1;
                item.val2 = val2;
                item.val3 = val3;
                item.val4 = val4;
        ...
        private static abstract class StackItem<T1, T2, T3, T4, T5, T6, T7>
        extends GenericStack {
            T1 val1;
            T2 val2;
            T3 val3;
            T4 val4;
        ...
        public static interface ICallback<T1, T2, T3, T4, T5, T6, T7> {
            public void accept(GenericStack var1, T1 var2, T2 var3, T3 var4, T4 var5, T5 var6, T6 var7, T7 var8);
        }
    }

    public static final class Params6 {

        public static final class CallbackStackItem<T1, T2, T3, T4, T5, T6>
        extends StackItem<T1, T2, T3, T4, T5, T6> {
            ...
            public static <T1, T2, T3, T4, T5, T6> CallbackStackItem<T1, T2, T3, T4, T5, T6> alloc(T1 val1, T2 val2, T3 val3, T4 val4, T5 val5, T6 val6, ICallback<T1, T2, T3, T4, T5, T6> callback) {
        ...
        private static abstract class StackItem<T1, T2, T3, T4, T5, T6>
        extends GenericStack {
            T1 val1;
            T2 val2;
            T3 val3;
        ...
        public static interface ICallback<T1, T2, T3, T4, T5, T6> {
            public void accept(GenericStack var1, T1 var2, T2 var3, T3 var4, T4 var5, T5 var6, T6 var7);
        }
    }
    ...
    public static final class Params5 {
        ...
        extends StackItem<T1, T2, T3, T4, T5> {
            ...
            public static <T1, T2, T3, T4, T5> CallbackStackItem<T1, T2, T3, T4, T5> alloc(T1 val1, T2 val2, T3 val3, T4 val4, T5 val5, ICallback<T1, T2, T3, T4, T5> callback) {
        ...
        private static abstract class StackItem<T1, T2, T3, T4, T5>
        extends GenericStack {
            T1 val1;
            T2 val2;
            T3 val3;
        ...
        public static interface ICallback<T1, T2, T3, T4, T5> {
            public void accept(GenericStack var1, T1 var2, T2 var3, T3 var4, T4 var5, T5 var6);
        }
    }
    ...
    public static final class Params4 {
        ...
        extends StackItem<T1, T2, T3, T4> {
            ...
            public static <T1, T2, T3, T4> CallbackStackItem<T1, T2, T3, T4> alloc(T1 val1, T2 val2, T3 val3, T4 val4, ICallback<T1, T2, T3, T4> callback) {
        ...
        private static abstract class StackItem<T1, T2, T3, T4>
        extends GenericStack {
            T1 val1;
            T2 val2;
            T3 val3;
        ...
        public static interface ICallback<T1, T2, T3, T4> {
            public void accept(GenericStack var1, T1 var2, T2 var3, T3 var4, T4 var5);
        }
    }
    ...
    public static final class Params3 {
        ...
        extends StackItem<T1, T2, T3> {
            ...
            public static <T1, T2, T3> CallbackStackItem<T1, T2, T3> alloc(T1 val1, T2 val2, T3 val3, ICallback<T1, T2, T3> callback) {
        ...
        private static abstract class StackItem<T1, T2, T3>
        extends GenericStack {
            T1 val1;
            T2 val2;
            T3 val3;
        ...
        public static interface ICallback<T1, T2, T3> {
            public void accept(GenericStack var1, T1 var2, T2 var3, T3 var4);
        }
    }
    ...
    public static final class Params2 {
        ...
        extends StackItem<T1, T2> {
            ...
            public static <T1, T2> CallbackStackItem<T1, T2> alloc(T1 val1, T2 val2, ICallback<T1, T2> callback) {
        ...
        private static abstract class StackItem<T1, T2>
        extends GenericStack {
            T1 val1;
            T2 val2;
        ...
        public static interface ICallback<T1, T2> {
            public void accept(GenericStack var1, T1 var2, T2 var3);
        }
    }
    ...
    public static final class Params1 {
        ...
        extends StackItem<T1> {
            ...
            public static <T1> CallbackStackItem<T1> alloc(T1 val1, ICallback<T1> callback) {
        ...
        private static abstract class StackItem<T1>
        extends GenericStack {
            T1 val1;
        ...
        public static interface ICallback<T1> {
            public void accept(GenericStack var1, T1 var2);
        }
    }

    public static abstract class GenericStack
    extends PooledObject {
        private final List<IPooledObject> stackItems = new ArrayList<IPooledObject>();
