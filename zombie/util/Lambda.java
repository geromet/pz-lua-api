...
public final class Lambda {
    ...
    public static <T1, T2, T3, T4, T5, T6> void capture(T1 val1, T2 val2, T3 val3, T4 val4, T5 val5, T6 val6, Stacks.Params6.ICallback<T1, T2, T3, T4, T5, T6> captureConsumer) {
        Stacks.Params6.CallbackStackItem<T1, T2, T3, T4, T5, T6> item = Stacks.Params6.CallbackStackItem.alloc(val1, val2, val3, val4, val5, val6, captureConsumer);
        item.invokeAndRelease();
    }

    public static <T1, T2, T3, T4, T5, T6, T7> void capture(T1 val1, T2 val2, T3 val3, T4 val4, T5 val5, T6 val6, T7 val7, Stacks.Params7.ICallback<T1, T2, T3, T4, T5, T6, T7> captureConsumer) {
        Stacks.Params7.CallbackStackItem<T1, T2, T3, T4, T5, T6, T7> item = Stacks.Params7.CallbackStackItem.alloc(val1, val2, val3, val4, val5, val6, val7, captureConsumer);
        item.invokeAndRelease();
    }
    ...
    public static <E, T1> void forEach(Consumer<Consumer<E>> forEachFunction, T1 captureVal1, Consumers.Params1.ICallback<E, T1> lambdaFunc) {
        Lambda.capture(forEachFunction, captureVal1, lambdaFunc, (stack, lForEachFunction, lCaptureVal1, lLambdaFunc) -> lForEachFunction.accept(stack.consumer(lCaptureVal1, lLambdaFunc)));
    }
    ...
    public static <E, T1, T2> void forEach(Consumer<Consumer<E>> forEachFunction, T1 captureVal1, T2 captureVal2, Consumers.Params2.ICallback<E, T1, T2> lambdaFunc) {
        Lambda.capture(forEachFunction, captureVal1, captureVal2, lambdaFunc, (stack, lForEachFunction, lCaptureVal1, lCaptureVal2, lLambdaFunc) -> lForEachFunction.accept(stack.consumer(lCaptureVal1, lCaptureVal2, lLambdaFunc)));
    }
    ...
    public static <E, T1> void forEachFrom(BiConsumer<List<E>, Consumer<E>> forEachFunction, List<E> from, T1 captureVal1, Consumers.Params1.ICallback<E, T1> lambdaFunc) {
        Lambda.capture(forEachFunction, from, captureVal1, lambdaFunc, (stack, lForEachFunction, lFrom, lCaptureVal1, lLambdaFunc) -> lForEachFunction.accept(lFrom, stack.consumer(lCaptureVal1, lLambdaFunc)));
    }
    ...
    public static <E, T1, T2> void forEachFrom(BiConsumer<List<E>, Consumer<E>> forEachFunction, List<E> from, T1 captureVal1, T2 captureVal2, Consumers.Params2.ICallback<E, T1, T2> lambdaFunc) {
        Lambda.capture(forEachFunction, from, captureVal1, captureVal2, lambdaFunc, (stack, lForEachFunction, lFrom, lCaptureVal1, lCaptureVal2, lLambdaFunc) -> lForEachFunction.accept(lFrom, stack.consumer(lCaptureVal1, lCaptureVal2, lLambdaFunc)));
    }
    ...
    public static <E, F, T1, T2, T3> void forEachFrom(BiConsumer<F, Consumer<E>> forEachFunction, F from, T1 captureVal1, T2 captureVal2, T3 captureVal3, Consumers.Params3.ICallback<E, T1, T2, T3> lambdaFunc) {
        Lambda.capture(forEachFunction, from, captureVal1, captureVal2, captureVal3, lambdaFunc, (stack, lForEachFunction, lFrom, lCaptureval1, lCaptureVal2, lCaptureVal3, lLambdaFunc) -> lForEachFunction.accept(lFrom, stack.consumer(lCaptureval1, lCaptureVal2, lCaptureVal3, lLambdaFunc)));
    }

    public static <E, F, T1, T2, T3, T4> void forEachFrom(BiConsumer<F, Consumer<E>> forEachFunction, F from, T1 captureVal1, T2 captureVal2, T3 captureVal3, T4 captureVal4, Consumers.Params4.ICallback<E, T1, T2, T3, T4> lambdaFunc) {
        Lambda.capture(forEachFunction, from, captureVal1, captureVal2, captureVal3, captureVal4, lambdaFunc, (stack, lForEachFunction, lFrom, lCaptureVal1, lCaptureVal2, lCaptureVal3, lCaptureVal4, lLambdaFunc) -> lForEachFunction.accept(lFrom, stack.consumer(lCaptureVal1, lCaptureVal2, lCaptureVal3, lCaptureVal4, lLambdaFunc)));
    }
    ...
    public static <E, T1, R> R find(Function<Predicate<E>, R> findFunction, T1 captureVal1, Predicates.Params1.ICallback<E, T1> lambdaFunc) {
        ReturnValueContainer returnContainer = ReturnValueContainer.alloc();
        Lambda.capture(findFunction, captureVal1, lambdaFunc, returnContainer, (stack, lFindFunction, lCaptureVal1, lLambdaFunc, lReturnContainer) -> {
            lReturnContainer.returnVal = lFindFunction.apply(stack.predicate(lCaptureVal1, lLambdaFunc));
        });
        Object returnval = returnContainer.returnVal;
    ...
    public static <E, T1> int indexOf(IntSupplierFunction<Predicate<E>> findFunction, T1 captureVal1, Predicates.Params1.ICallback<E, T1> lambdaFunc) {
        ...
        Lambda.capture(findFunction, captureVal1, lambdaFunc, returnContainer, (stack, lFindFunction, lCaptureVal1, lLambdaFunc, lReturnContainer) -> {
            lReturnContainer.returnVal = lFindFunction.getInt(stack.predicate(lCaptureVal1, lLambdaFunc));
        });
    ...
    public static <E, T1> boolean contains(Predicate<Predicate<E>> findFunction, T1 captureVal1, Predicates.Params1.ICallback<E, T1> lambdaFunc) {
        ...
        Lambda.capture(findFunction, captureVal1, lambdaFunc, returnContainer, (stack, lFindFunction, lCaptureVal1, lLambdaFunc, lReturnContainer) -> {
            lReturnContainer.returnVal = lFindFunction.test(stack.predicate(lCaptureVal1, lLambdaFunc));
        });
    ...
    public static <E, F extends Iterable<E>, T1> boolean containsFrom(BiPredicate<F, Predicate<E>> findFunction, F from, T1 captureVal1, Predicates.Params1.ICallback<E, T1> lambdaFunc) {
        ReturnValueContainerPrimitives.RVBoolean returnContainer = ReturnValueContainerPrimitives.RVBoolean.alloc();
        Lambda.capture(findFunction, from, captureVal1, lambdaFunc, returnContainer, (stack, lFindFunction, lFrom, lCaptureVal1, lLambdaFunc, lReturnContainer) -> {
            lReturnContainer.returnVal = lFindFunction.test(lFrom, stack.predicate(lCaptureVal1, lLambdaFunc));
        });
        boolean returnval = returnContainer.returnVal;
        returnContainer.release();
        return returnval;
    ...
    public static <T1> void invoke(Consumer<Runnable> runFunction, T1 captureVal1, Invokers.Params1.ICallback<T1> lambdaFunc) {
        Lambda.capture(runFunction, captureVal1, lambdaFunc, (stack, lRunFunction, lCaptureVal1, lLambdaFunc) -> lRunFunction.accept(stack.invoker(lCaptureVal1, lLambdaFunc)));
    }
    ...
    public static <T1, T2> void invoke(Consumer<Runnable> runFunction, T1 captureVal1, T2 captureVal2, Invokers.Params2.ICallback<T1, T2> lambdaFunc) {
        Lambda.capture(runFunction, captureVal1, captureVal2, lambdaFunc, (stack, lRunFunction, lCaptureVal1, lCaptureVal2, lLambdaFunc) -> lRunFunction.accept(stack.invoker(lCaptureVal1, lCaptureVal2, lLambdaFunc)));
    }
}
