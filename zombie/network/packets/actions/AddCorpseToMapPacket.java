...
public class AddCorpseToMapPacket
        ...
        if (GameServer.server) {
            ...
            if (sq != null) {
                ...
                for (int n = 0; n < GameServer.udpEngine.connections.size(); ++n) {
                    ...
                    if (c.getConnectedGUID() == connection.getConnectedGUID() || !c.isRelevantTo(this.x, this.y)) continue;
            ...
            LoggerManager.getLogger("item").write(connection.getIDStr() + " \"" + connection.getUserName() + "\" corpse +1 " + this.x + "," + this.y + "," + this.z);
        } else {
