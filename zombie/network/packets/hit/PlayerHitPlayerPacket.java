...
@PacketSetting(ordering=0, priority=0, reliability=3, requiredCapability=Capability.LoginOnServer, handlingType=3, anticheats={AntiCheat.HitDamage, AntiCheat.HitLongDistance, AntiCheat.HitWeaponAmmo, AntiCheat.HitWeaponRange, AntiCheat.HitWeaponRate, AntiCheat.Safety})
...
AntiCheatSafety.IAntiCheat {
    ...
    public void setData(Object ... values2) {
        this.set((IsoPlayer)values2[0], (HandWeapon)values2[1], (Boolean)values2[2], (Boolean)values2[3], (IsoPlayer)values2[4], ((Float)values2[5]).floatValue(), ((Float)values2[6]).floatValue(), (Boolean)values2[7]);
    }
    ...
    public void set(IsoPlayer wielder, HandWeapon weapon, boolean isIgnoreDamage, boolean isCriticalHit, IsoPlayer target, float damage, float range, boolean hitHead) {
        ...
        this.hit.set(damage, range, target.getHitForce(), target.getHitDir().x, target.getHitDir().y, hitHead, false);
