...
implements INetworkPacket {
    ...
    public void processServer(PacketTypes.PacketType packetType, UdpConnection connection) {
        ...
        System.out.println(String.format("LOS: isCouldSee(%d,%d,%d) = %s LosUtil = %s", this.squareX, this.squareY, this.squareZ, ServerLOS.instance.isCouldSee(player, square) ? "true" : "false", result.toString()));
    }
