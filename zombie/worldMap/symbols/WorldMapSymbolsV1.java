...
extends WorldMapSymbolsAPI {
    ...
    private final ArrayList<WorldMapBaseSymbolV1> symbols = new ArrayList();
    ...
    public WorldMapTextSymbolV1 addTranslatedText(String text, UIFont font, float x, float y) {
        ...
        return (WorldMapTextSymbolV1)this.symbols.get(this.symbols.size() - 1);
    }

    public WorldMapTextSymbolV1 addUntranslatedText(String text, UIFont font, float x, float y) {
    ...
    public WorldMapTextureSymbolV1 addTexture(String symbolID, float x, float y) {
        WorldMapTextureSymbol symbol = this.uiSymbols.addTexture(symbolID, x, y, 1.0f, 1.0f, 1.0f, 1.0f);
        return (WorldMapTextureSymbolV1)this.symbols.get(this.symbols.size() - 1);
    }
    ...
    public WorldMapBaseSymbolV1 getSymbolByIndex(int index) {
    ...
    private void reinit() {
        ...
        for (i = 0; i < this.uiSymbols.getSymbolCount(); ++i) {
            ...
            if (symbol instanceof WorldMapTextSymbol) {
                ...
                symbolV1 = s_textPool.alloc().init(this, textSymbol);
            ...
            symbolV1 = s_texturePool.alloc().init(this, textureSymbol);
            this.symbols.add(symbolV1);
        }
    }
    ...
    implements IWorldMapSymbolListener {
        ...
        public void onAdd(WorldMapBaseSymbol symbol) {
            ...
            if (symbol instanceof WorldMapTextSymbol) {
                WorldMapTextSymbol textSymbol = (WorldMapTextSymbol)symbol;
                WorldMapTextSymbolV1 symbolV1 = s_textPool.alloc().init(this.api, textSymbol);
                this.api.symbols.add(index, symbolV1);
                return;
            }
            if (symbol instanceof WorldMapTextureSymbol) {
                WorldMapTextureSymbol textureSymbol = (WorldMapTextureSymbol)symbol;
                WorldMapTextureSymbolV1 symbolV1 = s_texturePool.alloc().init(this.api, textureSymbol);
                this.api.symbols.add(index, symbolV1);
                return;
            }
        ...
        public void onBeforeRemove(WorldMapBaseSymbol symbol) {
            int index = this.indexOf(symbol);
            WorldMapBaseSymbolV1 symbolV1 = this.api.symbols.remove(index);
            symbolV1.release();
        }
    ...
    extends WorldMapBaseSymbolV1 {
        ...
        WorldMapTextSymbolV1 init(WorldMapSymbolsV1 owner, WorldMapTextSymbol symbol) {
    ...
    extends WorldMapBaseSymbolV1 {
        ...
        WorldMapTextureSymbolV1 init(WorldMapSymbolsV1 owner, WorldMapTextureSymbol symbol) {
            super.init(owner, symbol);
    ...
    extends PooledObject {
        ...
        WorldMapBaseSymbolV1 init(WorldMapSymbolsV1 owner, WorldMapBaseSymbol symbol) {
            this.owner = owner;
            this.symbol = symbol;
            return this;
        }
