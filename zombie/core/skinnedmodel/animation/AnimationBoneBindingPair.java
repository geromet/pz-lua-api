...
public final class AnimationBoneBindingPair {
    ...
    public int getBoneIdxA() {
        return AnimationBoneBindingPair.getBoneIdx(this.getBoneA());
    }

    public int getBoneIdxB() {
        return AnimationBoneBindingPair.getBoneIdx(this.getBoneB());
    }
    ...
    public String toString() {
        ...
        String tab = "\t";
        return this.getClass().getName() + endln + "{" + endln + "\tboneBindingA:" + StringUtils.indent(String.valueOf(this.boneBindingA)) + endln + "\tboneBindingB:" + StringUtils.indent(String.valueOf(this.boneBindingB)) + endln + "}";
    }
}
