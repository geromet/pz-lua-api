...
public final class JAssImpImporter {
    ...
    static AiNode FindNode(String name, AiNode node) {
        ...
        for (int i = 0; i < children.size(); ++i) {
            ...
            AiNode n = JAssImpImporter.FindNode(name, child);
            if (n == null) continue;
            return n;
        }
        return null;
    ...
    static Matrix4f getMatrixFromAiMatrix(AiMatrix4f srcMat) {
        return JAssImpImporter.getMatrixFromAiMatrix(srcMat, new Matrix4f());
    }
    ...
    static void CollectBoneNodes(ArrayList<AiNode> boneNodes, AiNode bonenode) {
        ...
        for (int i = 0; i < bonenode.getNumChildren(); ++i) {
            JAssImpImporter.CollectBoneNodes(boneNodes, bonenode.getChildren().get(i));
        }
    }

    static String DumpAiMatrix(AiMatrix4f matrix) {
        Object s = "";
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.get(0, 0)));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.get(0, 1)));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.get(0, 2)));
        s = (String)s + String.format("%1$.8f\n ", Float.valueOf(matrix.get(0, 3)));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.get(1, 0)));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.get(1, 1)));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.get(1, 2)));
        s = (String)s + String.format("%1$.8f\n ", Float.valueOf(matrix.get(1, 3)));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.get(2, 0)));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.get(2, 1)));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.get(2, 2)));
        s = (String)s + String.format("%1$.8f\n ", Float.valueOf(matrix.get(2, 3)));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.get(3, 0)));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.get(3, 1)));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.get(3, 2)));
        s = (String)s + String.format("%1$.8f\n ", Float.valueOf(matrix.get(3, 3)));
        return s;
    }

    static String DumpMatrix(Matrix4f matrix) {
        Object s = "";
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.m00));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.m01));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.m02));
        s = (String)s + String.format("%1$.8f\n ", Float.valueOf(matrix.m03));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.m10));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.m11));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.m12));
        s = (String)s + String.format("%1$.8f\n ", Float.valueOf(matrix.m13));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.m20));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.m21));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.m22));
        s = (String)s + String.format("%1$.8f\n ", Float.valueOf(matrix.m23));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.m30));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.m31));
        s = (String)s + String.format("%1$.8f, ", Float.valueOf(matrix.m32));
        s = (String)s + String.format("%1$.8f\n ", Float.valueOf(matrix.m33));
        return s;
    }
    ...
    static AiBone FindAiBone(String name, List<AiBone> bones) {
        ...
        for (int k = 0; k < numBones; ++k) {
            ...
            if (!bonename.equals(name)) continue;
            return aiBone;
        }
        return null;
    }
    ...
    static Vector3f GetKeyFramePosition(AiNodeAnim animNode, float time) {
        ...
        int sidx = -1;
        int k = 0;
        while (k < animNode.getNumPosKeys() && !((t = (float)animNode.getPosKeyTime(k)) > time)) {
            sidx = k++;
            if (t != time) continue;
        ...
        if (animNode.getNumPosKeys() > sidx + 1) {
    ...
    static Quaternion GetKeyFrameRotation(AiNodeAnim animNode, float time) {
        ...
        int sidx = -1;
        int k = 0;
        while (k < animNode.getNumRotKeys() && !((t = (float)animNode.getRotKeyTime(k)) > time)) {
            sidx = k++;
            if (t != time) continue;
    ...
    static Vector3f GetKeyFrameScale(AiNodeAnim animNode, float time) {
        ...
        int sidx = -1;
        int k = 0;
        while (k < animNode.getNumScaleKeys() && !((t = (float)animNode.getScaleKeyTime(k)) > time)) {
            sidx = k++;
            if (t != time) continue;
        ...
        if (animNode.getNumScaleKeys() > sidx + 1) {
    ...
    static void replaceHashMapKeys(HashMap<String, Integer> hashMap, String countKey) {
        ...
        hashMap.clear();
        for (Map.Entry<String, Integer> e : tempHashMap.entrySet()) {
            String key = JAssImpImporter.getSharedString(e.getKey(), countKey);
