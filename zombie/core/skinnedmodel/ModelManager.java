...
public final class ModelManager {
    ...
    private final ReferencedObjectPool<ModelInstance> modelInstancePool = new ReferencedObjectPool<ModelInstance>(ModelInstance::new);
    ...
    public void update() {
        ...
        if (IsoWorld.instance != null && IsoWorld.instance.currentCell != null) {
            ...
            for (int i2 = 0; i2 < vehicles.size(); ++i2) {
                BaseVehicle vehicle = vehicles.get(i2);
    ...
    implements PredicatedFileWatcher.IPredicatedFileWatcherCallback {
        ...
        public void call(String entryKey) {
            ...
            if (anim != null) {
                if (!anim.isEmpty()) {
                    DebugLog.General.debugln("Reloading animation: %s", this.this$0.animAssetToString(anim));
