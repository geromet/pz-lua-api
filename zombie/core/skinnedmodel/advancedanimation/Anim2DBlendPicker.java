...
public final class Anim2DBlendPicker {
    ...
    private HullComparer hullComparer;
    ...
    private void BuildHull() {
        HashMap<Edge, Counter> edges = new HashMap<Edge, Counter>();
        Counter newCounter = new Counter();
        for (Anim2DBlendTriangle tri : this.tris) {
            Counter c2 = edges.putIfAbsent(new Edge(tri.node1, tri.node2), newCounter);
            if (c2 == null) {
                c2 = newCounter;
                newCounter = new Counter();
            }
            c2.Increment();
            c2 = edges.putIfAbsent(new Edge(tri.node2, tri.node3), newCounter);
            if (c2 == null) {
                c2 = newCounter;
                newCounter = new Counter();
            }
            c2.Increment();
            c2 = edges.putIfAbsent(new Edge(tri.node3, tri.node1), newCounter);
            if (c2 == null) {
                c2 = newCounter;
                newCounter = new Counter();
            }
        ...
        ArrayList<Anim2DBlend> hull = new ArrayList<Anim2DBlend>(hullNodes);
        float centerX = 0.0f;
        float centerY = 0.0f;
        ...
        this.hullComparer = new HullComparer(centerX /= (float)hull.size(), centerY /= (float)hull.size());
    ...
    public PickResults Pick(float x, float y, PickResults result) {
        ...
        dummyNode.posX = x *= 1.1f;
        dummyNode.posY = y *= 1.1f;
        int idx = Anim2DBlendPicker.LowerBoundIdx(this.hull, dummyNode, this.hullComparer);
        ...
        float s = Anim2DBlendPicker.ProjectPointToLine(x, y, n1.posX, n1.posY, n2.posX, n2.posY);
        if (s < 0.0f) {
            result.numNodes = 1;
            result.node1 = n1;
            result.scale1 = 1.0f;
    ...
    void render(float pickX, float pickY) {
        ...
        for (int i = 0; i < this.tris.size(); ++i) {
            ...
            SpriteRenderer.instance.renderline(null, (int)((float)(x + 100) + tri.node1.posX * 200.0f / 2.0f), (int)((float)(y + 100) - tri.node1.posY * 200.0f / 2.0f), (int)((float)(x + 100) + tri.node2.posX * 200.0f / 2.0f), (int)((float)(y + 100) - tri.node2.posY * 200.0f / 2.0f), 0.5f, 0.5f, 0.5f, 1.0f);
            SpriteRenderer.instance.renderline(null, (int)((float)(x + 100) + tri.node2.posX * 200.0f / 2.0f), (int)((float)(y + 100) - tri.node2.posY * 200.0f / 2.0f), (int)((float)(x + 100) + tri.node3.posX * 200.0f / 2.0f), (int)((float)(y + 100) - tri.node3.posY * 200.0f / 2.0f), 0.5f, 0.5f, 0.5f, 1.0f);
            SpriteRenderer.instance.renderline(null, (int)((float)(x + 100) + tri.node3.posX * 200.0f / 2.0f), (int)((float)(y + 100) - tri.node3.posY * 200.0f / 2.0f), (int)((float)(x + 100) + tri.node1.posX * 200.0f / 2.0f), (int)((float)(y + 100) - tri.node1.posY * 200.0f / 2.0f), 0.5f, 0.5f, 0.5f, 1.0f);
        }
        float size = 8.0f;
        PickResults result = this.Pick(pickX, pickY, new PickResults());
        if (result.node1 != null) {
            SpriteRenderer.instance.render(null, (float)(x + 100) + result.node1.posX * 200.0f / 2.0f - size / 2.0f, (float)(y + 100) - result.node1.posY * 200.0f / 2.0f - size / 2.0f, size, size, 0.0f, 1.0f, 0.0f, 1.0f, null);
        }
        if (result.node2 != null) {
            SpriteRenderer.instance.render(null, (float)(x + 100) + result.node2.posX * 200.0f / 2.0f - size / 2.0f, (float)(y + 100) - result.node2.posY * 200.0f / 2.0f - size / 2.0f, size, size, 0.0f, 1.0f, 0.0f, 1.0f, null);
        }
        if (result.node3 != null) {
            SpriteRenderer.instance.render(null, (float)(x + 100) + result.node3.posX * 200.0f / 2.0f - size / 2.0f, (float)(y + 100) - result.node3.posY * 200.0f / 2.0f - size / 2.0f, size, size, 0.0f, 1.0f, 0.0f, 1.0f, null);
        }
        size = 4.0f;
        SpriteRenderer.instance.render(null, (float)(x + 100) + pickX * 200.0f / 2.0f - size / 2.0f, (float)(y + 100) - pickY * 200.0f / 2.0f - size / 2.0f, size, size, 0.0f, 0.0f, 1.0f, 1.0f, null);
    }
