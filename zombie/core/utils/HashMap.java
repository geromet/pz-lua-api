...
public class HashMap {
    ...
    public Object get(Object key) {
        Bucket bucket = this.buckets[Math.abs(key.hashCode()) % this.capacity];
        for (int i = 0; i < bucket.size(); ++i) {
            if (bucket.keys[i] == null || !bucket.keys[i].equals(key)) continue;
    ...
    public String toString() {
        ...
        string = new StringBuilder("HashMap[" + String.valueOf(string) + "]");
