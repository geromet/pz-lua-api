...
extends OptionGroup {
    public final RenderTiles renderTiles = this.newOptionGroup(new RenderTiles());

    public static final class RenderTiles
    extends OptionGroup {
        ...
        public final IsoGridSquare isoGridSquare = this.newOptionGroup(new IsoGridSquare());

        public static final class IsoGridSquare
        extends OptionGroup {
            ...
            public final Walls walls = this.newOptionGroup(new Walls());
            public final Floor floor = this.newOptionGroup(new Floor());
