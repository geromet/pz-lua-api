...
public final class ZomboidBitFlag {
    ...
    public void set(int off, boolean b) {
        ...
        if (b) {
            ...
            this.isoFlagTypeSet.remove((Object)IsoFlagType.fromIndex(off));
        }
    }
    ...
    public boolean isSet(int off) {
        return this.isoFlagTypeSet.contains((Object)IsoFlagType.fromIndex(off));
    }

    public boolean isSet(IsoFlagType flag) {
        return this.isoFlagTypeSet.contains((Object)flag);
    }
    ...
    public void set(IsoFlagType flag, boolean b) {
        if (b) {
            ...
            this.isoFlagTypeSet.remove((Object)flag);
        }
    }
