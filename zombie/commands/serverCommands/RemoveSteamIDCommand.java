...
public class RemoveSteamIDCommand
extends CommandBase {
    ...
    protected String Command() {
        ...
        try {
            if (!ServerWorldDatabase.instance.isSteamIDAllowed(steamID)) {
                LoggerManager.getLogger("admin").write(this.getExecutorUsername() + " tried to remove user with SteamID " + steamID + " but it doesn't exists in allowed SteamIDs");
