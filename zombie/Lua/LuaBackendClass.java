...
implements KahluaTable {
    ...
    public Object call(String func) {
        return LuaManager.caller.pcall(LuaManager.thread, this.typeTable.rawget(func), (Object)this.table)[1];
    }
    ...
    public int callInt(String func) {
        return ((Double)LuaManager.caller.pcall(LuaManager.thread, this.typeTable.rawget(func), (Object)this.table)[1]).intValue();
    }
    ...
    public int callInt(String func, Object param1, Object param2, Object param3, Object param4, Object param5) {
        return ((Double)LuaManager.caller.pcall(LuaManager.thread, this.typeTable.rawget(func), this.table, param1, param2, param3, param4, param5)[1]).intValue();
    }

    public float callFloat(String func) {
        return ((Double)LuaManager.caller.pcall(LuaManager.thread, this.typeTable.rawget(func), (Object)this.table)[1]).floatValue();
    }
    ...
    public float callFloat(String func, Object param1, Object param2, Object param3, Object param4, Object param5) {
        return ((Double)LuaManager.caller.pcall(LuaManager.thread, this.typeTable.rawget(func), this.table, param1, param2, param3, param4, param5)[1]).floatValue();
    }

    public boolean callBool(String func) {
        return (Boolean)LuaManager.caller.pcall(LuaManager.thread, this.typeTable.rawget(func), (Object)this.table)[1];
    }
