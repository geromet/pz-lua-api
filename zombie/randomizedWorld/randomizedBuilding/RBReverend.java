...
extends RandomizedBuildingBase {
    ...
    public void randomizeBuilding(BuildingDef def) {
        ...
        Object bible = InventoryItemFactory.CreateItem("Base.Book_Bible");
        if (bible == null) {
            return;
        }
        dean.addItemToSpawnAtDeath((InventoryItem)bible);
        RBReverend.trySpawnStoryItem("Goblet", dean.getSquare(), Rand.Next(0.4f, 0.8f), Rand.Next(0.4f, 0.8f), 0.0f);
    }
