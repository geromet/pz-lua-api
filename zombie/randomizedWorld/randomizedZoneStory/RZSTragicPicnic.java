...
extends RandomizedZoneStoryBase {
    ...
    public void randomizeZoneStory(Zone zone) {
        ...
        IsoGridSquare midSq = RZSTragicPicnic.getSq(midX, midY, zone.z);
        if (midSq != null) {
            IsoGridSquare sq3;
            IsoGridSquare sq2;
            IsoGridSquare sq;
            this.cleanSquareAndNeighbors(midSq);
            InventoryContainer bag = (InventoryContainer)InventoryItemFactory.CreateItem("Base.Bag_PicnicBasket");
            if (bag != null) {
            ...
            if ((sq = midSq.getAdjacentSquare(IsoDirections.getRandom())) != null) {
            ...
            if ((sq2 = midSq.getAdjacentSquare(IsoDirections.getRandom())) != null) {
                if (sq != sq2) {
                    RandomizedZoneStoryBase.cleanSquareForStory(sq);
                }
                if (Rand.NextBool(2)) {
            ...
            if ((sq3 = midSq.getAdjacentSquare(IsoDirections.getRandom())) != null) {
                if (sq3 != sq && sq3 != sq2) {
                    RandomizedZoneStoryBase.cleanSquareForStory(sq);
                }
