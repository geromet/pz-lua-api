...
extends RandomizedZoneStoryBase {
    ...
    public void randomizeZoneStory(Zone zone) {
        ...
        IsoGridSquare square = RZSOrphanedFawn.getRandomExtraFreeUnoccupiedSquare(this, zone);
        if (square != null) {
            ...
            if (square2 != null && !square2.isFree(true)) {
                square2 = RZSOrphanedFawn.getRandomExtraFreeUnoccupiedSquare(this, zone);
            }
            if (square2 != null) {
        ...
        if ((square3 = RZSOrphanedFawn.getRandomExtraFreeUnoccupiedSquare(this, zone)) != null) {
            ...
            this.addItemOnGround(square3, (String)gun.get(Rand.Next(gun.size())));
        }
    }
}
