...
extends RandomizedZoneStoryBase {
    ...
    public void randomizeZoneStory(Zone zone) {
        ...
        IsoGridSquare midSq = RZSSadCamp.getSq(midX, midY, zone.z);
        ...
        if (Rand.NextBool(2)) {
            ...
            BaseVehicle vehicle = this.addVehicle(zone, RZSSadCamp.getSq(x, y, zone.z), null, "medium", vehicleType, null, null, "Evacuee");
            if (vehicle != null) {
        ...
        String outfitName = RZSSadCamp.getOutfits().get(Rand.Next(RZSSadCamp.getOutfits().size()));
