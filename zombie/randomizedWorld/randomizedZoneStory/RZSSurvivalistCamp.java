...
@UsedFromLua
public class RZSSurvivalistCamp
extends RandomizedZoneStoryBase {
    ...
    public void randomizeZoneStory(Zone zone) {
        ...
        IsoGridSquare midSq = RZSSurvivalistCamp.getSq(midX, midY, zone.z);
        ...
        for (int i = 0; i < bags.size(); ++i) {
            ...
            InventoryContainer bag = (InventoryContainer)InventoryItemFactory.CreateItem((String)bags.get(i));
            IsoGridSquare sq = this.getRandomExtraFreeSquare(this, zone);
            if (sq == null || bag == null) continue;
        ...
        if (Rand.NextBool(2)) {
            ...
            BaseVehicle vehicle = this.addVehicle(zone, RZSSurvivalistCamp.getSq(x, y, zone.z), null, null, vehicleType, null, null, "Survivalist");
            if (vehicle != null) {
                int key;
