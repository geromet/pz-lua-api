...
extends RandomizedZoneStoryBase {
    ...
    public void randomizeZoneStory(Zone zone) {
        int i;
        ArrayList<String> fishes = RZSFishingTrip.getFishes();
        ArrayList<String> fishingtools = RZSFishingTrip.getFishingTools();
        this.cleanAreaForStory(this, zone);
        this.addVehicle(zone, RZSFishingTrip.getSq(zone.x, zone.y, zone.z), null, null, "Base.PickUpTruck", null, null, "Fisherman");
        ...
        InventoryContainer toolbox = (InventoryContainer)InventoryItemFactory.CreateItem("Base.Tacklebox");
