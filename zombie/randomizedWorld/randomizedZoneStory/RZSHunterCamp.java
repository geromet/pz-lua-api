...
extends RandomizedZoneStoryBase {
    ...
    public void randomizeZoneStory(Zone zone) {
        ...
        ArrayList<String> clutter = RZSHunterCamp.getForestClutter();
        IsoGridSquare midSq = RZSHunterCamp.getSq(midX, midY, zone.z);
        ...
        if ((vehicle = this.addVehicle(zone, RZSHunterCamp.getSq(x2, y2, 0), null, null, vehicleType, null, null, "Hunter")) != null) {
