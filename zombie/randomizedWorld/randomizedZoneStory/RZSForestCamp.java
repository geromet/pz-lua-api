...
extends RandomizedZoneStoryBase {
    ...
    public void randomizeZoneStory(Zone zone) {
        ...
        IsoGridSquare midSq = RZSForestCamp.getSq(midX, midY, zone.z);
        this.cleanAreaForStory(this, zone);
        this.cleanSquareAndNeighbors(midSq);
        this.addCampfireOrPit(midSq);
        this.addItemOnGround(RZSForestCamp.getSq(midX, midY, zone.z), fireClutter.get(Rand.Next(fireClutter.size())));
