...
extends RandomizedZoneStoryBase {
    ...
    public void randomizeZoneStory(Zone zone) {
        ...
        this.addItemOnGround(RZSBuryingCamp.getSq(openGravesX + 1, openGravesY + 1, zone.z), "Base.Shovel");
        ...
        if (zeds != null && !zeds.isEmpty()) {
            ...
            IsoDeadBody body = RZSBuryingCamp.createRandomDeadBody(RZSBuryingCamp.getSq(openGravesX, openGravesY, zone.z), null, Rand.Next(7, 12), 0, null);
            if (body != null) {
