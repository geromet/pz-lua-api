...
public final class MoodleTextureSet {
    ...
    private final Map<MoodleType, Texture> moodleTextures = new HashMap<MoodleType, Texture>();

    public MoodleTextureSet(int size) {
        this.size = size;
        int flags = 0;
        String dir = "media/ui/Moodles/" + size;
        this.border = Texture.getSharedTexture(dir + "/_Moodles_BGoutline.png", flags |= 0x40);
