...
public final class RagdollBuilder {
    ...
    private void getSkinningDataSkeletonHierarchy() {
        ...
        for (SkeletonBone skeletonBone : skeletonBones) {
            ...
            if (boneAt == null) {
                ...
                RagdollBuilder.boneHierarchy[skeletonBone.index()] = -1;
                continue;
            }
            SkeletonBone parentBone = boneAt.getParentSkeletonBone();
            RagdollBuilder.boneHierarchy[skeletonBone.index()] = parentBone.index();
    ...
    private void getBoneTransforms() {
        ...
        for (SkeletonBone skeletonBone : skeletonBones) {
            ...
            if (bone == null) {
                RagdollBuilder.boneTransformData[floatArrayIndex++] = 0.0f;
                RagdollBuilder.boneTransformData[floatArrayIndex++] = 0.0f;
                RagdollBuilder.boneTransformData[floatArrayIndex++] = 0.0f;
                RagdollBuilder.boneTransformData[floatArrayIndex++] = 0.0f;
                RagdollBuilder.boneTransformData[floatArrayIndex++] = 0.0f;
                RagdollBuilder.boneTransformData[floatArrayIndex++] = 0.0f;
                RagdollBuilder.boneTransformData[floatArrayIndex++] = 1.0f;
                continue;
            }
            ...
            RagdollBuilder.boneTransformData[floatArrayIndex++] = -this.position.x * 1.5f;
            RagdollBuilder.boneTransformData[floatArrayIndex++] = -this.position.y * 1.5f;
            RagdollBuilder.boneTransformData[floatArrayIndex++] = -this.position.z * 1.5f;
            RagdollBuilder.boneTransformData[floatArrayIndex++] = this.rotation.x;
            RagdollBuilder.boneTransformData[floatArrayIndex++] = this.rotation.y;
            RagdollBuilder.boneTransformData[floatArrayIndex++] = this.rotation.z;
            RagdollBuilder.boneTransformData[floatArrayIndex++] = this.rotation.w;
        }
    }
