...
public final class BodyLocation {
    ...
    private final List<ItemBodyLocation> exclusive = new ArrayList<ItemBodyLocation>();
    private final List<ItemBodyLocation> hideModel = new ArrayList<ItemBodyLocation>();
    private final List<ItemBodyLocation> altModel = new ArrayList<ItemBodyLocation>();
