...
public final class AnimalSoundState {
    ...
    public boolean shouldPlay() {
        ...
        if (this.isPlayingDesiredSound()) {
            return true;
        }
        if (this.getIntervalExpireTime(this.desiredSoundName) == 0L) {
            return true;
        }
    ...
    public boolean isPlayingDesiredSound() {
        ...
        return StringUtils.equals(this.playingSoundName, this.desiredSoundName);
    }
