...
extends BaseAction {
    ...
    @Override
    public void update() {
        LuaTimedAction.statObj[0] = this.table.rawget("character");
        LuaTimedAction.statObj[1] = this.table.rawget("param1");
        LuaTimedAction.statObj[2] = this.table.rawget("param2");
        LuaTimedAction.statObj[3] = this.table.rawget("param3");
        LuaTimedAction.statObj[4] = this.table.rawget("param4");
        LuaTimedAction.statObj[5] = this.table.rawget("param5");
    ...
    public boolean valid() {
        Object[] o = LuaManager.caller.pcall(LuaManager.thread, this.table.rawget("isValidFunc"), this.table.rawget("character"), this.table.rawget("param1"), this.table.rawget("param2"), this.table.rawget("param3"), this.table.rawget("param4"), this.table.rawget("param5"));
        return o.length > 0 && (Boolean)o[0] != false;
    }
