...
extends NetworkCharacterAI {
    ...
    public void set(ZombiePacket packet) {
        ...
        if (ModelManager.instance.isCreated()) {
            packet.dirAngle = packet.target != -1 ? this.zombie.getAnimationPlayer().getTargetAngle() : this.zombie.getAnimAngleRadians();
        }
    ...
    public void preupdate() {
        if (GameClient.client) {
            ...
            if (this.lastDirection != (direction = (byte)IsoDirections.fromAngle(this.zombie.getForwardDirection()).ordinal())) {
