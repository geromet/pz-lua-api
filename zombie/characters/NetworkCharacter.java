...
public class NetworkCharacter {
    ...
    void extrapolate(int t) {
        float f = (float)(t - this.d1.t) / (float)(this.d1.t - this.d2.t);
    ...
    void extrapolateInternal(int t, float px, float py) {
        float f = (float)(t - this.d1.t) / (float)(t - this.d1.t);
    ...
    void interpolate(int t) {
        float f = (float)(t - this.d1.t) / (float)(this.d2.t - this.d1.t);
    ...
    public Transform predict(int dt, int t, float px, float py, float rx, float ry) {
    ...
    public Transform reconstruct(int t, float px, float py, float rx, float ry) {
        this.transform.moving = false;
        this.transform.operation = Operation.NONE;
        if (this.d2.t != 0) {
            if ((long)t + this.deltaTime <= (long)this.d2.t) {
