...
public class NineGridTexture {
    ...
    public void renderInnerBased(int x, int y, int w, int h, float r, float g, float b, float a) {
        SpriteRenderer.instance.renderi(this.topLeft, x - this.outer, (y += 5) - this.outer, this.outer, this.outer, r, g, b, a, null);
        ...
        SpriteRenderer.instance.renderi(this.left, x - this.outer, y, this.outer, h -= 7, r, g, b, a, null);
