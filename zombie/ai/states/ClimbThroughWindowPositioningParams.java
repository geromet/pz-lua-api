...
implements INetworkPacketField {
    ...
    private static final Pool<ClimbThroughWindowPositioningParams> s_pool = new Pool<ClimbThroughWindowPositioningParams>(ClimbThroughWindowPositioningParams::new);
