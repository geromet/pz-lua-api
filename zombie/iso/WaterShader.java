...
extends Shader {
    ...
    public void updateWaterParams(TextureDraw texd, int playerIndex) {
        ...
        GL20.glUniform4f(this.waterViewport, IsoCamera.getOffscreenLeft(playerIndex), IsoCamera.getOffscreenTop(playerIndex), (float)camera.offscreenWidth / camera.zoom, (float)camera.offscreenHeight / camera.zoom);
