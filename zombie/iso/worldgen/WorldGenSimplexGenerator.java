...
public class WorldGenSimplexGenerator {
    ...
    private final WGSimplex[] noises = new WGSimplex[6];
    private final WGSimplex selector;

    public WorldGenSimplexGenerator(long seed) {
        Random rnd = new Random(seed + 100L);
        this.noises[0] = new WGSimplex(rnd.nextDouble(), rnd.nextDouble(), rnd.nextDouble(), 128.0, 0.0);
        rnd = new Random(seed + 200L);
        this.noises[1] = new WGSimplex(rnd.nextDouble(), rnd.nextDouble(), rnd.nextDouble(), 128.0, 0.0);
        rnd = new Random(seed + 300L);
        this.noises[2] = new WGSimplex(rnd.nextDouble(), rnd.nextDouble(), rnd.nextDouble(), 128.0, 0.0);
        rnd = new Random(seed + 400L);
        this.noises[3] = new WGSimplex(rnd.nextDouble(), rnd.nextDouble(), rnd.nextDouble(), 128.0, 0.0);
        rnd = new Random(seed + 500L);
        this.noises[4] = new WGSimplex(rnd.nextDouble(), rnd.nextDouble(), rnd.nextDouble(), 128.0, 0.0);
        rnd = new Random(seed + 600L);
        this.noises[5] = new WGSimplex(rnd.nextDouble(), rnd.nextDouble(), rnd.nextDouble(), 128.0, 0.0);
