...
public class OreVeinConfig {
    ...
    public OreVeinConfig(List<TileGroup> tiles, int centerRadius, float centerProb, int armsAmountMin, int armsAmountMax, int armsDistMin, int armsDistMax, int armsDeltaAngle, float armsProb, float probability) {
        this.tiles = tiles;
