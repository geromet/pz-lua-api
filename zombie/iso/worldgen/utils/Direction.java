...
public enum Direction {
    ...
    private static final List<Direction> rose;
    ...
    private Direction(int index, int opposite, int prev, int next, int x, int y, String name) {
        this.index = index;
    ...
    public Direction prev() {
        return Direction.values()[this.prev];
    }

    public Direction next() {
        return Direction.values()[this.next];
    }

    static {
        cardinals = List.of(NORTH, SOUTH, WEST, EAST);
        diagonals = List.of(NORTH_WEST, NORTH_EAST, SOUTH_WEST, SOUTH_EAST);
        rose = List.of(NORTH, SOUTH, WEST, EAST, NORTH_WEST, NORTH_EAST, SOUTH_WEST, SOUTH_EAST);
    }
}
