...
extends Shader {
    ...
    public void updatePuddlesParams(int userId, int z) {
        ...
        GL20.glUniform4f(this.waterViewport, IsoCamera.getOffscreenLeft(userId), IsoCamera.getOffscreenTop(userId), (float)camera.offscreenWidth / camera.zoom, (float)camera.offscreenHeight / camera.zoom);
