...
public final class FBORenderObjectHighlight {
    ...
    private void renderObject(int playerIndex, IsoObject object) {
        ...
        for (int i = object.getObjectIndex(); i < objectCount; ++i) {
            ...
            if (this.isRenderedToChunkTexture(object1) || this.isRenderedEveryFrame(object1) || object != object1 && this.objectSet.contains(object1) || this.objectSet2.contains(object1) || object1 instanceof IsoWorldInventoryObject && DebugOptions.instance.fboRenderChunk.itemsInChunkTexture.getValue()) continue;
    ...
    public boolean shouldRenderObjectHighlight(IsoObject object) {
        ...
        if (object.isHighlighted(playerIndex)) {
            if (PerformanceSettings.fboRenderChunk) {
                return this.isRendering() || this.isRenderedEveryFrame(object);
            }
            return true;
        }
        return false;
