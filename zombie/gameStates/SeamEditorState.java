...
@UsedFromLua
public final class SeamEditorState
extends GameState {
    ...
    public void enter() {
        ...
        if (this.selfUi.isEmpty()) {
            this.luaEnv.caller.pcall(this.luaEnv.thread, this.luaEnv.env.rawget("SeamEditorUI_InitUI"), new Object[0]);
    ...
    public static SeamEditorState checkInstance() {
        if (instance != null) {
            if (SeamEditorState.instance.table == null || SeamEditorState.instance.table.getMetatable() == null) {
                instance = null;
            } else if (SeamEditorState.instance.table.getMetatable().rawget("_LUA_RELOADED_CHECK") == null) {
                instance = null;
            }
        }
        if (instance == null) {
            return new SeamEditorState();
        }
        return instance;
    }
    ...
    extends BooleanConfigOption {
        public BooleanDebugOption(SeamEditorState this$0, String name, boolean defaultValue) {
