...
extends GameState {
    ...
    private final BooleanDebugOption drawPixelGrid = new BooleanDebugOption(this, "DrawPixelGrid", true);
    private final BooleanDebugOption drawSpriteGrid = new BooleanDebugOption(this, "DrawSpriteGrid", false);
    private final BooleanDebugOption drawSpriteGridTextureMask = new BooleanDebugOption(this, "DrawSpriteGridTextureMask", false);
    private final BooleanDebugOption drawSquareBox = new BooleanDebugOption(this, "DrawSquareBox", false);
    private final BooleanDebugOption drawSolidSquareBox = new BooleanDebugOption(this, "DrawSolidSquareBox", false);
    ...
    private final BooleanDebugOption drawTextureMask = new BooleanDebugOption(this, "DrawTextureMask", false);
    private final BooleanDebugOption drawTextureOutline = new BooleanDebugOption(this, "DrawTextureOutline", false);
    private final BooleanDebugOption drawUnderlyingSprite = new BooleanDebugOption(this, "DrawUnderlyingSprite", false);
    ...
    public void enter() {
        ...
        if (this.selfUi.isEmpty()) {
            this.luaEnv.caller.pcall(this.luaEnv.thread, this.luaEnv.env.rawget("TileGeometryEditor_InitUI"), new Object[0]);
    ...
    public static TileGeometryState checkInstance() {
        if (instance != null) {
            if (TileGeometryState.instance.table == null || TileGeometryState.instance.table.getMetatable() == null) {
                instance = null;
            } else if (TileGeometryState.instance.table.getMetatable().rawget("_LUA_RELOADED_CHECK") == null) {
                instance = null;
            }
        }
        if (instance == null) {
            return new TileGeometryState();
        }
        return instance;
    }
    ...
    extends BooleanConfigOption {
        public BooleanDebugOption(TileGeometryState this$0, String name, boolean defaultValue) {
