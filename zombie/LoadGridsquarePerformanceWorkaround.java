...
public final class LoadGridsquarePerformanceWorkaround {
    ...
    public static void LoadGridsquare(IsoGridSquare sq) {
        if (ItemPicker.instance.begin(sq)) {
            ...
            for (int i = 0; i < size; ++i) {
                ...
                if (!GameClient.client) {
                    ItemPicker.instance.checkObject(object);
                }
                if (object.sprite == null || object.sprite.name == null || ContainerOverlays.instance.hasOverlays(object)) continue;
                TileOverlays.instance.updateTileOverlaySprite(object);
            }
        }
        ItemPicker.instance.end(sq);
    }
