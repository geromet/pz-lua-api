...
def detect_pz_version(repo_root: pathlib.Path) -> str:
    """
    Try to detect the PZ build number from files adjacent to the repository.
    Checks (in order):
...
# ---------------------------------------------------------------------------
pz_version = detect_pz_version(_REPO_ROOT)
viewer_dir  = _REPO_ROOT
