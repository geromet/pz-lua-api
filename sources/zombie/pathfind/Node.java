...
public final class Node {
    ...
    boolean isConnectedTo(Node other) {
        ...
        for (int i = 0; i < this.visible.size(); ++i) {
            ...
            if (cxn.node1 != other && cxn.node2 != other) continue;
            return true;
        }
        return false;
    }
    ...
    public boolean isOnEdgeOfLoadedArea() {
        ...
        return PZMath.coordmodulo(y, 8) == 7 && PolygonalMap2.instance.getChunkFromSquarePos(x, y + 1) == null;
    }
