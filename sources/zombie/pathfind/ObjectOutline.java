...
final class ObjectOutline {
    ...
    static void setSolid(int x, int y, int z, ObjectOutline[][] oo) {
        ObjectOutline.setWest(x, y, z, oo);
        ObjectOutline.setNorth(x, y, z, oo);
        ObjectOutline.setWest(x + 1, y, z, oo);
        ObjectOutline.setNorth(x, y + 1, z, oo);
    }

    static void setWest(int x, int y, int z, ObjectOutline[][] oo) {
        ObjectOutline f1 = ObjectOutline.get(x, y, z, oo);
        if (f1 != null) {
            if (f1.nw) {
                f1.nwS = false;
            } else {
        ...
        f1 = ObjectOutline.get(x, y + 1, z, oo);
        if (f1 == null) {
            if (fff != null) {
                fff.wCutoff = true;
            }
    ...
    static void setNorth(int x, int y, int z, ObjectOutline[][] oo) {
        ...
        ObjectOutline fff = f1;
        f1 = ObjectOutline.get(x + 1, y, z, oo);
        if (f1 == null) {
            if (fff != null) {
                fff.nCutoff = true;
            }
    ...
    static ObjectOutline get(int x, int y, int z, ObjectOutline[][] oo) {
        ...
        if (oo[x][y] == null) {
            oo[x][y] = ObjectOutline.alloc().init(x, y, z);
        }
        return oo[x][y];
    }
    ...
    void trace_NW_S(ObjectOutline[][] oo, Node extend) {
        ...
        if (this.nwW) {
            ...
            ObjectOutline f1 = ObjectOutline.get(this.x - 1, this.y, this.z, oo);
            if (f1 == null) {
                return;
            }
            if (f1.nS) {
    ...
    void trace_NW_W(ObjectOutline[][] oo, Node extend) {
        ...
        if (this.nwN) {
            ...
            ObjectOutline f1 = ObjectOutline.get(this.x, this.y - 1, this.z, oo);
            if (f1 == null) {
                return;
            }
            if (f1.wW) {
    ...
    void trace_W_E(ObjectOutline[][] oo, Node extend) {
        ...
        if (extend != null) {
            ...
            node2 = Node.alloc().init((float)this.x + 0.3f, (float)(this.y + 1) - 0.3f, this.z);
            this.nodes.add(node2);
        }
        this.wE = false;
        if (this.wCutoff) {
    ...
    void trace_N_N(ObjectOutline[][] oo, Node extend) {
        ...
        if (extend != null) {
            ...
            node2 = Node.alloc().init((float)(this.x + 1) - 0.3f, (float)this.y - 0.3f, this.z);
            this.nodes.add(node2);
        }
        this.nN = false;
        if (this.nCutoff) {
        ...
        if (f1.nwN) {
            ...
            f1 = ObjectOutline.get(this.x + 1, this.y - 1, this.z, oo);
            if (f1 == null) {
                return;
            }
            if (f1.wW) {
    ...
    void trace(ObjectOutline[][] oo, ArrayList<Node> nodes) {
        nodes.clear();
        this.nodes = nodes;
        Node node1 = Node.alloc().init((float)this.x - 0.3f, (float)this.y - 0.3f, this.z);
        nodes.add(node1);
        this.trace_NW_N(oo, null);
