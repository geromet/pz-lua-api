...
public final class ImprovedFogDrawer
extends TextureDraw.GenericDrawer {
    ...
    public void render() {
        ...
        for (int i = 0; i < numRectangles; ++i) {
            ...
            float glZ = 0.0f;
            vbor.addQuadDepth(sx, sy, 0.0f, u0, v0, depth0, ex, sy, 0.0f, u1, v0, depth1, ex, ey, 0.0f, u1, v1, depth2, sx, ey, 0.0f, u0, v1, depth3, 1.0f, 1.0f, 1.0f, this.alpha);
            vbor.endRun();
        }
        vbor.flush();
    ...
    void addRectangle(float sx, float sy, float ex, float ey, float u0, float v0, float u1, float v1, float offset, float depthBottom, float depthTop, float layerAlpha, int zLayer) {
