...
public class BasementsV1 {
    public void addAccessDefinitions(String mapID, KahluaTable table) {
        ...
        while (iterator2.advance()) {
            ...
            KahluaTable definitionTable = (KahluaTable)iterator2.getValue();
    ...
    public void addSpawnLocations(String mapID, KahluaTable table) {
        ...
        KahluaTableIterator iterator2 = table.iterator();
        while (iterator2.advance()) {
            KahluaTable locationTable = (KahluaTable)iterator2.getValue();
            ...
            Object object = locationTable.rawget("choices");
            if (object instanceof KahluaTable) {
                ...
                KahluaTableIterator iterator22 = kahluaTable.iterator();
                while (iterator22.advance()) {
                    String s;
                    String basementName;
                    Object value = iterator22.getValue();
                    if (!(value instanceof String) || (basementName = (s = (String)value).trim()).isEmpty()) continue;
    ...
    public BasementSpawnLocation registerBasementSpawnLocation(String mapID, String name, String type, int x, int y, int z, int width, int height, KahluaTable properties) {
        BasementsPerMap basementsPerMap = Basements.getInstance().getOrCreatePerMap(mapID);
