...
AntiCheatHitWeaponRate.IAntiCheat {
    ...
    public void setData(Object ... values2) {
        this.set((IsoPlayer)values2[0], (HandWeapon)values2[1], (Boolean)values2[2], (Boolean)values2[3], (IsoAnimal)values2[4], ((Float)values2[5]).floatValue(), ((Float)values2[6]).floatValue(), (Boolean)values2[7]);
    }
