...
public class Newspaper {
    public static final Newspaper KENTUCKY_HERALD = Newspaper.registerBase("KentuckyHerald", List.of("KentuckyHerald_July6", "KentuckyHerald_July13", "KentuckyHerald_July14", "KentuckyHerald_July15", "KentuckyHerald_July16"));
    public static final Newspaper KNOX_KNEWS = Newspaper.registerBase("KnoxKnews", List.of("KnoxKnews_July1", "KnoxKnews_July2", "KnoxKnews_July3", "KnoxKnews_July4", "KnoxKnews_July5", "KnoxKnews_July6"));
    public static final Newspaper LOUISVILLE_SUN_TIMES = Newspaper.registerBase("LouisvilleSunTimes", List.of("LouisvilleSunTimes_July6", "LouisvilleSunTimes_July13", "LouisvilleSunTimes_July14", "LouisvilleSunTimes_July15", "LouisvilleSunTimes_July16"));
    public static final Newspaper NATIONAL_DISPATCH = Newspaper.registerBase("NationalDispatch", List.of("NationalDispatch_July6", "NationalDispatch_July7", "NationalDispatch_July12", "NationalDispatch_July13", "NationalDispatch_July14", "NationalDispatch_July15"));
    ...
    public static Newspaper register(String id, List<String> issues) {
        return Newspaper.register(false, id, new Newspaper(id, issues));
    }

    private static Newspaper registerBase(String id, List<String> issues) {
        return Newspaper.register(true, id, new Newspaper(id, issues));
    }
