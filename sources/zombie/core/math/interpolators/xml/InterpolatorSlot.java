...
public class InterpolatorSlot {
    @XmlElements(value={@XmlElement(name="EaseInQuad", type=LerpEaseInQuad.class), @XmlElement(name="EaseOutInQuad", type=LerpEaseOutInQuad.class), @XmlElement(name="EaseOutQuad", type=LerpEaseOutQuad.class), @XmlElement(name="Linear", type=LerpLinear.class), @XmlElement(name="One", type=LerpOne.class), @XmlElement(name="Polyline", type=LerpPolyline.class), @XmlElement(name="Sequence", type=LerpSequence.class), @XmlElement(name="Zero", type=LerpZero.class)})
