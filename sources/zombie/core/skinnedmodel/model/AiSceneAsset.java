...
@Deprecated
public final class AiSceneAsset
extends Asset {
    AiScene scene;
    ...
    protected AiSceneAsset(AssetPath path, AssetManager manager, AiSceneAssetParams params) {
        super(path, manager);
    ...
    public static final class AiSceneAssetParams
