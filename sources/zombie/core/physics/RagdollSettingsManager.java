...
public class RagdollSettingsManager {
    ...
    private final RagdollSetting[] ragdollSettings = new RagdollSetting[1];
    ...
    public boolean usePhysicHitReaction(IsoGameCharacter isoGameCharacter) {
        if (this.isForcedHitReaction()) {
            HitReactionSetting hitReactionSetting = this.getHitReactionSetting(0);
    ...
    private RagdollSetting initRagdollSetting(int id, String name, float defaultValue, float min, float max) {
    ...
    private HitReactionSetting initHitReactionSetting(int id, String name, float defaultValue, float min, float max) {
    ...
    private ForceHitReactionLocation initForceHitReactionLocation(int id, String name) {
    ...
    public RagdollSetting getSetting(int id) {
        if (id >= 0 && id < this.ragdollSettings.length) {
    ...
    public HitReactionSetting getHitReactionSetting(int id) {
        if (id >= 0 && id < this.hitReactionSettings.length) {
    ...
    public boolean getEnabledSetting(RagdollBodyPart bodyPart) {
        ...
        return this.getHitReactionSetting((int)partID).isAdminOverride;
    }

    public float getChanceSetting(RagdollBodyPart bodyPart) {
        int partID = bodyPart.ordinal() + 1;
        return this.getHitReactionSetting((int)partID).adminValue;
    }
    ...
    public float getGlobalImpulseSetting() {
        return this.getHitReactionSetting((int)12).adminValue;
    }

    public float getGlobalUpImpulseSetting() {
        return this.getHitReactionSetting((int)24).adminValue;
    }

    public ForceHitReactionLocation getForceHitReactionLocation(int id) {
        if (id >= 0 && id < this.forceHitReactionLocations.length) {
    ...
    private void setup() {
        int i;
        for (i = 0; i < this.ragdollSettings.length; ++i) {
            this.ragdollSettings[i] = new RagdollSetting();
        }
        for (i = 0; i < this.hitReactionSettings.length; ++i) {
            this.hitReactionSettings[i] = new HitReactionSetting();
        }
        for (i = 0; i < this.forceHitReactionLocations.length; ++i) {
            this.forceHitReactionLocations[i] = new ForceHitReactionLocation();
        }
    ...
    public boolean isForcedHitReaction() {
        for (int i = 0; i < this.forceHitReactionLocations.length; ++i) {
            if (!this.forceHitReactionLocations[i].getAdminValue()) continue;
            return true;
        }
        return false;
    }
    ...
    public static class RagdollSetting {
        ...
        public RagdollSetting init(int id, String name, float defaultValue, float min, float max) {
            this.id = id;
            this.name = name;
            this.min = min;
            this.max = max;
    ...
    public static class HitReactionSetting {
        ...
        public HitReactionSetting init(int id, String name, float defaultValue, float min, float max) {
            this.id = id;
            this.name = name;
            this.min = min;
            this.max = max;
    ...
    public static class ForceHitReactionLocation {
        ...
        public ForceHitReactionLocation init(int id, String name) {
            this.id = id;
            this.name = name;
            return this;
        }
