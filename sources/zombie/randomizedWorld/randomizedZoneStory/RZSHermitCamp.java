...
extends RandomizedZoneStoryBase {
    ...
    public void randomizeZoneStory(Zone zone) {
        ...
        IsoGridSquare midSq = RZSHermitCamp.getSq(midX, midY, zone.z);
        ArrayList<String> clutter = RZSHermitCamp.getForestClutter();
        ArrayList<String> bagClutter = RZSHermitCamp.getBagClutter();
        ArrayList<String> fireClutter = RZSHermitCamp.getFireClutter();
