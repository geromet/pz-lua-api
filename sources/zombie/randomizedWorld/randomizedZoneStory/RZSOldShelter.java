...
extends RandomizedZoneStoryBase {
    ...
    public void randomizeZoneStory(Zone zone) {
        ...
        IsoGridSquare midSq = RZSOldShelter.getSq(midX, midY, zone.z);
        ...
        this.addItemOnGround(this.getRandomFreeSquare(this, zone), RZSOldShelter.getOldShelterClutterItem());
    }
}
