...
extends RandomizedZoneStoryBase {
    ...
    public void randomizeZoneStory(Zone zone) {
        ...
        IsoGridSquare midSq = RZSDean.getSq(midX, midY, zone.z);
        if (midSq == null) {
            return;
        }
        ...
        this.addItemOnGround(this.getRandomFreeSquare(this, zone), RZSDean.getOldShelterClutterItem());
        this.addItemOnGround(this.getRandomFreeSquare(this, zone), RZSDean.getOldShelterClutterItem());
