...
extends RandomizedZoneStoryBase {
    ...
    public void randomizeZoneStory(Zone zone) {
        ...
        ArrayList<String> briefcaseClutter = RZSVanCamp.getBriefcaseClutter();
        IsoGridSquare midSq = RZSVanCamp.getSq(midX, midY, zone.z);
        ...
        InventoryContainer briefcase = (InventoryContainer)InventoryItemFactory.CreateItem("Base.Briefcase");
        ...
        if ((vehicle = this.addVehicle(zone, RZSVanCamp.getSq(x, y, zone.z), null, null, "Base.Van", null, null, null)) != null) {
