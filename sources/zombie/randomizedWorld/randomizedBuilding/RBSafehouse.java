...
extends RandomizedBuildingBase {
    ...
    public void randomizeBuilding(BuildingDef def) {
        ...
        boolean trash = (mean = Rand.NextBool(8)) || Rand.NextBool(2);
            ...
            for (int y = def.y - 1; y < def.y2 + 1; ++y) {
                for (int z = -32; z < 31; ++z) {
                    ...
                    for (int o = 0; o < sq.getObjects().size(); ++o) {
                        ...
                        if (!kidsRoom && obj.getContainer() != null && sq.getRoom() != null && sq.getRoom().getBuilding().getDef() == def && Rand.Next(100) <= 70 && sq.getRoom().getName() != null && safehouseLoot.containers.containsKey(obj.getContainer().getType())) {
                        ...
                        if (!canTrash || Rand.Next(1000) > trashFactor) continue;
                        this.trashSquare(sq);
                    }
                }
            }
