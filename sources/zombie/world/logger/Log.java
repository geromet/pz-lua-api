...
public class Log {
    ...
    public static class VersionChangedScript
    extends BaseScriptLog {
    ...
    public static class RegisterScript
    extends BaseScriptLog {
    ...
    public static abstract class BaseScriptLog
    extends BaseLog {
        ...
        protected String getScriptString() {
            return "name = \"" + this.info.getName() + "\", registeryID = " + this.info.getRegistryID() + ", version = " + this.info.getVersion() + ", isLoaded = " + this.info.isLoaded();
        }
    }

    public static class RegisterString
    extends BaseLog {
        ...
        @Override
        public void saveAsText(FileWriter w, String padding) throws IOException {
            w.write(padding + "{ type = \"" + (this.register ? reg : unreg) + "\", register = " + this.registerName + ", id = " + this.id + ", value = \"" + this.s + "\" }" + System.lineSeparator());
        }
    }
    ...
    extends BaseItemLog {
        ...
        @Override
        public void saveAsText(FileWriter w, String padding) throws IOException {
            w.write(padding + "{ type = \"modchange_" + this.getTypeTag() + "\", oldModID = \"" + this.oldModId + "\", " + this.getItemString() + " }" + System.lineSeparator());
        }
    }
    ...
    extends BaseItemLog {
        ...
        @Override
        public void saveAsText(FileWriter w, String padding) throws IOException {
            w.write(padding + "{ type = \"removed_" + this.getTypeTag() + "\", scriptMissing = " + this.isScriptMissing + ", " + this.getItemString() + " }" + System.lineSeparator());
        }
    }
