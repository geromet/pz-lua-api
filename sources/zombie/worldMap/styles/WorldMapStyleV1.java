...
public class WorldMapStyleV1 {
    ...
    public final ArrayList<WorldMapStyleLayerV1> layers = new ArrayList();
    ...
    public WorldMapStyleLayerV1 newLineLayer(String id) throws IllegalArgumentException {
    ...
    public WorldMapStyleLayerV1 newPolygonLayer(String id) throws IllegalArgumentException {
        WorldMapPolygonStyleLayer layer = new WorldMapPolygonStyleLayer(id);
        this.style.addLayer(layer);
        return this.layers.get(this.style.getLayerCount() - 1);
    }

    public WorldMapStyleLayerV1 newTextureLayer(String id) throws IllegalArgumentException {
    ...
    public WorldMapStyleLayerV1 getLayerByIndex(int index) {
        return this.layers.get(index);
    }

    public WorldMapStyleLayerV1 getLayerByName(String id) {
    ...
    public int indexOfLayer(String id) {
        for (int i = 0; i < this.layers.size(); ++i) {
            WorldMapStyleLayerV1 layer = this.layers.get(i);
            if (!layer.layer.id.equals(id)) continue;
            return i;
        }
        return -1;
    }
    ...
    private int indexOfLayer(WorldMapStyleLayer layer) {
        for (int i = 0; i < this.layers.size(); ++i) {
            WorldMapStyleLayerV1 layerV1 = this.layers.get(i);
    ...
    extends IWorldMapStyleListener {
        ...
        void onAdd(WorldMapStyleLayer origLayer) {
            if (origLayer instanceof WorldMapLineStyleLayer) {
                ...
                WorldMapLineStyleLayerV1 layerV1 = new WorldMapLineStyleLayerV1(this.api, layer);
            ...
            if (origLayer instanceof WorldMapPolygonStyleLayer) {
                ...
                WorldMapPolygonStyleLayerV1 layerV1 = new WorldMapPolygonStyleLayerV1(this.api, layer);
                this.api.layers.add(this.api.style.indexOf(layer), layerV1);
                return;
            }
            if (origLayer instanceof WorldMapTextureStyleLayer) {
                WorldMapTextureStyleLayer layer = (WorldMapTextureStyleLayer)origLayer;
                WorldMapTextureStyleLayerV1 layerV1 = new WorldMapTextureStyleLayerV1(this.api, layer);
                this.api.layers.add(this.api.style.indexOf(layer), layerV1);
                return;
            }
            WorldMapStyleLayerV1 layerV1 = new WorldMapStyleLayerV1(this.api, origLayer);
        ...
        void onBeforeRemove(WorldMapStyleLayer layer) {
            ...
            WorldMapStyleLayerV1 layerV1 = this.api.layers.remove(index);
        }
        ...
        void onMoveLayer(int indexFrom, int indexTo) {
            WorldMapStyleLayerV1 layerV1 = this.api.layers.remove(indexFrom);
    ...
    extends WorldMapStyleLayerV1 {
        WorldMapLineStyleLayer lineStyle;

        WorldMapLineStyleLayerV1(WorldMapStyleV1 owner, WorldMapLineStyleLayer layer) {
            super(owner, layer);
            this.lineStyle = (WorldMapLineStyleLayer)this.layer;
        }

        public void setFilter(String key, String value) {
            this.lineStyle.filterKey = key;
            this.lineStyle.filterValue = value;
            this.lineStyle.filter = (feature, args2) -> feature.hasLineString() && value.equals(feature.properties.get(key));
        }
    ...
    extends WorldMapStyleLayerV1 {
        WorldMapPolygonStyleLayer polygonStyle;

        WorldMapPolygonStyleLayerV1(WorldMapStyleV1 owner, WorldMapPolygonStyleLayer layer) {
            super(owner, layer);
            this.polygonStyle = (WorldMapPolygonStyleLayer)this.layer;
        }
        ...
        public void setFilter(String key, String value) {
            ...
            if ("*".equals(value)) {
                this.polygonStyle.filter = (feature, args2) -> feature.hasPolygon() && feature.properties.containsKey(key);
                return;
            }
            this.polygonStyle.filter = (feature, args2) -> feature.hasPolygon() && value.equals(feature.properties.get(key));
        }
        ...
        public void setFillRGBA(int index, int r, int g, int b, int a) {
            this.polygonStyle.fill.get((int)index).r = r;
            this.polygonStyle.fill.get((int)index).g = g;
            this.polygonStyle.fill.get((int)index).b = b;
            this.polygonStyle.fill.get((int)index).a = a;
        }

        public void setFillZoom(int index, float zoom) {
            this.polygonStyle.fill.get((int)index).zoom = PZMath.clamp(zoom, 0.0f, 24.0f);
        }

        public float getFillZoom(int index) {
            return this.polygonStyle.fill.get((int)index).zoom;
        }

        public int getFillRed(int index) {
            return this.polygonStyle.fill.get((int)index).r;
        }

        public int getFillGreen(int index) {
            return this.polygonStyle.fill.get((int)index).g;
        }

        public int getFillBlue(int index) {
            return this.polygonStyle.fill.get((int)index).b;
        }

        public int getFillAlpha(int index) {
            return this.polygonStyle.fill.get((int)index).a;
        }
        ...
        public void setScaleZoom(int index, float zoom) {
            this.polygonStyle.scale.get((int)index).zoom = PZMath.clamp(zoom, 0.0f, 24.0f);
        }

        public void setScaleValue(int index, int scale) {
            this.polygonStyle.scale.get((int)index).f = PZMath.clamp((float)scale, 0.0f, Float.MAX_VALUE);
        }
        ...
        public void setTextureZoom(int index, float zoom) {
            this.polygonStyle.texture.get((int)index).zoom = PZMath.clamp(zoom, 0.0f, 24.0f);
        }

        public float getTextureZoom(int index) {
            return this.polygonStyle.texture.get((int)index).zoom;
        }

        public void setTexturePath(int index, String texturePath) {
            this.polygonStyle.texture.get((int)index).texturePath = texturePath;
            this.polygonStyle.texture.get((int)index).texture = Texture.getTexture(texturePath);
        }

        public String getTexturePath(int index) {
            return this.polygonStyle.texture.get((int)index).texturePath;
        }

        public Texture getTexture(int index) {
            return this.polygonStyle.texture.get((int)index).texture;
        }

        public void setTextureScaling(int index, String scalingStr) {
            this.polygonStyle.texture.get((int)index).scaling = WorldMapStyleLayer.TextureScaling.valueOf(scalingStr);
        }

        public String getTextureScaling(int index) {
            return this.polygonStyle.texture.get((int)index).scaling.name();
        }
    }
    ...
    extends WorldMapStyleLayerV1 {
        WorldMapTextureStyleLayer textureStyle;

        WorldMapTextureStyleLayerV1(WorldMapStyleV1 owner, WorldMapTextureStyleLayer layer) {
            super(owner, layer);
            this.textureStyle = (WorldMapTextureStyleLayer)this.layer;
        }
        ...
        public void setFillRGBA(int index, int r, int g, int b, int a) {
            this.textureStyle.fill.get((int)index).r = r;
            this.textureStyle.fill.get((int)index).g = g;
            this.textureStyle.fill.get((int)index).b = b;
            this.textureStyle.fill.get((int)index).a = a;
        }

        public void setFillZoom(int index, float zoom) {
            this.textureStyle.fill.get((int)index).zoom = PZMath.clamp(zoom, 0.0f, 24.0f);
        }

        public float getFillZoom(int index) {
            return this.textureStyle.fill.get((int)index).zoom;
        }

        public int getFillRed(int index) {
            return this.textureStyle.fill.get((int)index).r;
        }

        public int getFillGreen(int index) {
            return this.textureStyle.fill.get((int)index).g;
        }

        public int getFillBlue(int index) {
            return this.textureStyle.fill.get((int)index).b;
        }

        public int getFillAlpha(int index) {
            return this.textureStyle.fill.get((int)index).a;
        }
        ...
        public void setTextureZoom(int index, float zoom) {
            this.textureStyle.texture.get((int)index).zoom = PZMath.clamp(zoom, 0.0f, 24.0f);
        }

        public float getTextureZoom(int index) {
            return this.textureStyle.texture.get((int)index).zoom;
        }

        public void setTexturePath(int index, String texturePath) {
            this.textureStyle.texture.get((int)index).texturePath = texturePath;
            this.textureStyle.texture.get((int)index).texture = Texture.getTexture(texturePath);
        }

        public String getTexturePath(int index) {
            return this.textureStyle.texture.get((int)index).texturePath;
        }

        public Texture getTexture(int index) {
            return this.textureStyle.texture.get((int)index).texture;
        }
    }
}
