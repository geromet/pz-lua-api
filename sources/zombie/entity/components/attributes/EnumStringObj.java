...
@UsedFromLua
public class EnumStringObj<E extends Enum<E>> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnumStringObj)) {
            return false;
        }
        EnumStringObj other = (EnumStringObj)o;
    ...
    public String toString() {
        ...
        String s = "E" + String.valueOf(this.enumValues);
        this.sort();
        s = s + " S[";
        for (int i = 0; i < this.stringValues.size(); ++i) {
            s = s + this.stringValues.get(i);
            if (i >= this.stringValues.size() - 1) continue;
            s = s + ",";
        }
        s = s + "]";
        return s;
    ...
    public EnumStringObj<E> copy() {
        EnumStringObj<E> copy = new EnumStringObj<E>();
