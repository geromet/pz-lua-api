...
public abstract class BaseAnimalSoundManager {
    ...
    private final Comparator<IsoAnimal> comp = new Comparator<IsoAnimal>(this){
        final /* synthetic */ BaseAnimalSoundManager this$0;
        {
            BaseAnimalSoundManager baseAnimalSoundManager = this$0;
            Objects.requireNonNull(baseAnimalSoundManager);
            this.this$0 = baseAnimalSoundManager;
        }
